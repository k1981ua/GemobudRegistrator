...
//=======================================================================
bool DconThreadReader::Init(QString serPort, int i7015Addr, int avgPnts)
{
    if (serPort!="") serialPort=serPort;
    if (i7015Addr!=0) i7015Address=i7015Addr;
...
//=======================================================================
QVector<CalPoint> ModbusThreadReader::GetVectorCalPoints()
{
    return calPoints;
}
*/
//=======================================================================
bool DconThreadReader::TestConnection(QString serPort, int i7015Addr)
{
...
void DconThreadReader::run()
{
   ...
   int errors=0;
    ...
    for(;;)
    {
        ...
        int cr='\r';
        qDebug() << query << "  len:" << strlen(query) << "    " << cr;
        qDebug() << port.write(query,strlen(query));
